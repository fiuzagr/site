layout: page
title: Resume of Guilherme Rizzo Fiuza
tagline: Fullstack Developer
tags : [resumo, fullstack, php, javascript, html, css]
permalink: /en/resume/
---
...
{{config.author.en.nationality}}, {{config.author.age}} years ago<br>
{{config.author.en.location}}<br>
